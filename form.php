		...
		<div class="container justify-content-center p=0 m=0" id="content">
          ...
          print($mess);
			...
			<form method="POST" action="">
				...
				<label for="inName">Имя:</label>
				<input type="text" id="inName" name="inName" <?php if ($errors['inName']) {print 'class="error"';} ?> value="<?php print $values['inName']; ?>" placeholder="Иия">
				<label for="inEmail">e-mail:</label>
				<input type="text" id="inEmail" name="inEmail" <?php if ($errors['inEmail']) {print 'class="error"';} ?> value="<?php print $values['inEmail']; ?>" placeholder="email">
				<br/>Дата рождения:<br/>
					<input name="inDate" id="inDate" <?php if ($errors['inDate']) {print 'class="error"';} ?> value="<?php print $values['inDate']; ?>" type="text" placeholder="01.01.1990"/>
				<label for="inGender">Пол:</label>
                ...
                <input type="radio" name="inLimb" <?php if ($errors['inLimb']) {print 'class="error"';} ?> value=">4" <?php if ($values['inLimb'] == '>4') {print 'checked="checked"';} ?> />>4
				<label <?php if ($errors['inSuperpowers']) {print 'class="error"';} ?> for="inSuperpowers">Сверхспособности:</label>
				...
				<textarea type="text" rows="10" cols="45" name="inMessage" placeholder="Сообщение"><?php printf($values['inMessage']);?></textarea>
